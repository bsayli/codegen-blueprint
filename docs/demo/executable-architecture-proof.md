...
1. Codegen Blueprint generates projects with explicit architectural boundaries (standard/layered or hexagonal).
2. With `--enforcement strict`, those boundaries become **generated ArchUnit rules**.
...
<p align="center">
  <img src="../images/demo/01-clean-controller.png" width="900" />
  <br/>
...
<p align="center">
  <img src="../images/demo/02-controller-domain-violation.png" width="900" />
  <br/>
...
<p align="center">
  <img src="../images/demo/03-archunit-failure.png" width="900" />
  <br/>
