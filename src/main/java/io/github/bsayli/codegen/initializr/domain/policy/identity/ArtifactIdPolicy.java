...
import static io.github.bsayli.codegen.initializr.domain.error.code.Field.ARTIFACT_ID;
...
import io.github.bsayli.codegen.initializr.domain.policy.rule.AllowedCharsRule;
import io.github.bsayli.codegen.initializr.domain.policy.rule.LengthBetweenRule;
import io.github.bsayli.codegen.initializr.domain.policy.rule.NoConsecutiveCharRule;
import io.github.bsayli.codegen.initializr.domain.policy.rule.NoEdgeCharRule;
import io.github.bsayli.codegen.initializr.domain.policy.rule.NotBlankRule;
import io.github.bsayli.codegen.initializr.domain.policy.rule.StartsWithLetterRule;
